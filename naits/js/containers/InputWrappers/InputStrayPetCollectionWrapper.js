...
class InputStrayPetCollectionWrapper extends React.Component {
  constructor (props) {
    super(props)
    this.state = {
      showSearchPopup: false,
      elementIdName: null,
      fieldIdName: 'COLLECTION_LOCATION',
      gridToDisplay: 'AREA',
      filterGrid: false
    }
  }
...
InputStrayPetCollectionWrapper.contextTypes = {
...
export default connect(mapStateToProps)(InputStrayPetCollectionWrapper)
