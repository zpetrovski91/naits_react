...
class InputSearchPetCampaignWrapper extends React.Component {
  constructor (props) {
    super(props)
    this.state = {
  ...
  componentDidMount () {
    ...
    const deleteBtn = document.getElementById('delete_form_btn')
    if (deleteBtn) {
      ...
      <div id='search_modal_content' className='modal-content'>
        ...
        <div id='search_modal_body' className='modal-body'>
          <ResultsGrid
            ...
            customGridDataWS='GET_VALID_CAMPAIGN_EVENTS_FOR_PETS'
          />
        </div>
      </div>
...
InputSearchPetCampaignWrapper.contextTypes = {
...
export default connect(mapStateToProps)(InputSearchPetCampaignWrapper)
