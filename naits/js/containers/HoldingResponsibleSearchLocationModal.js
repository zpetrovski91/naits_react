...
class HoldingResponsibleSearchLocationModal extends React.Component {
  constructor (props) {
    super(props)
    this.state = {}
  }
...
HoldingResponsibleSearchLocationModal.contextTypes = {
...
export default connect(mapStateToProps)(HoldingResponsibleSearchLocationModal)
